...
export type ProductOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"SellerID" | "id" | "name" | "stock" | "price" | "description", ExtArgs["result"]["product"]>
...
export interface ProductDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const productWithSellerIDOnly = await prisma.product.findMany({ select: { SellerID: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Products and only return the `SellerID`
   * const productWithSellerIDOnly = await prisma.product.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Products and only return the `SellerID`
   * const productWithSellerIDOnly = await prisma.product.updateManyAndReturn({
   *   select: { SellerID: true },
   *   where: {
   *     // ... provide filter here
   *   },
